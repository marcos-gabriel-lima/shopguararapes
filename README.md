...
Os filmes ficam em [src/lib/data.ts](src/lib/data.ts) (catálogo de exemplo, com pôsteres reais).
Para trocar/adicionar filmes, é só editar esse arquivo. Nenhuma chave ou configuração é necessária.
